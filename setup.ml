...
(* OASIS_START *)
(* DO NOT EDIT (digest: 581ef6e0acb61fa3b255ee76ca6a4aee) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Bounding_box"; "Rtree_intf"; "Rtree"];
                      lib_pack = true;
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Osm_xml";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\020\217\250|\182\181\192C\004\223=Y\189\192&\004";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
