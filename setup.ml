...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5a0fb1b58073e93239fb69f26099db56) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_rstartree", []))];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_rstartree.ml"});
               Test
                 ({
                     cs_name = "RStarTreeTest";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "test_rstartree"
                        ]
                   })
            ];
          plugins =
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\189|\151\031\146\210\127\152\248c\019<\129\216a\r";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
